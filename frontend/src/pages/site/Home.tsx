  ...
  return (
    <div className="bg-[#f4f5f7]">
      ...
      <section className="textura-giz relative overflow-hidden bg-azul px-6 py-[clamp(64px,10vw,110px)] text-white">
        {/* ícones flutuando */}
        <svg aria-hidden="true" className="flutua pointer-events-none absolute left-[8%] top-[20%] hidden h-11 w-11 text-amarelo md:block [--giro:-10deg]" style={{ animationDelay: '.2s' }} viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z" /></svg>
        <svg aria-hidden="true" className="flutua pointer-events-none absolute right-[9%] top-[16%] hidden h-10 w-10 text-white/80 md:block [--giro:9deg]" style={{ animationDelay: '1s' }} viewBox="0 0 24 24" fill="currentColor"><path d="M4 7h3l2-2h6l2 2h3a1 1 0 0 1 1 1v11a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1zm8 3a4 4 0 1 0 0 8 4 4 0 0 0 0-8z" /></svg>
